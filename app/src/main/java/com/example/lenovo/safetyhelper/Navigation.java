...
public class Navigation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LayoutInflater infalter = (LayoutInflater) Navigation.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        BaiduNaviManagerFactory.getRouteGuideManager().setRouteGuideEventListener(
                new IBNRouteGuideManager.IRouteGuideEventListener() {
                    ...
                    public void onCommonEventCall(int what, int arg1, int arg2, Bundle bundle) {
                        ...
                        if(a==false) {
                            if (bundle.getString(BNaviCommonParams.BNGuideKey.TOTAL_REMAIN_TIME) != null) {
                                remain_time_car = bundle.getString(BNaviCommonParams.BNGuideKey.TOTAL_REMAIN_TIME).toString();
                                a = true;
                                Intent it = new Intent(Navigation.this, Protection.class);
                                it.putExtra("remain_time_car", remain_time_car);
                                startActivity(it);
                            }
                        }
                    }
    ...
    private void showOverlay() {
        ...
        BNItemizedOverlay overlay = new BNItemizedOverlay(
                Navigation.this.getResources().getDrawable(R.drawable
                        .navi_guide_turn));
    ...
    private IBNRouteGuideManager.OnNavigationListener mOnNavigationListener =
            new IBNRouteGuideManager.OnNavigationListener() {
                ...
                public void notifyOtherAction(int actionType, int arg1, int arg2, Object obj) {
                    if (actionType == 0) {
                        // 导航到达目的地 自动退出
                        Log.i("waht", "notifyOtherAction actionType = " + actionType + ",导航到达目的地！");
